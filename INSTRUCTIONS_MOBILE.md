...
- **Android (Release / Play Store)** : Consultez le guide dédié [GENERER_RELEASE_ANDROID.md](./GENERER_RELEASE_ANDROID.md) ou exécutez :
  - **Android App Bundle (.aab)** : `npm run build:android:bundle`
  - **APK Release (.apk)** : `npm run build:android:apk`
  - **Android Studio** : Dans Android Studio, utilisez **Build > Generate Signed Bundle / APK...**.
