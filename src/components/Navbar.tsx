          ...
          <Link to="/" className="flex items-center gap-3 group shrink-0">
            ...
            <div className="hidden sm:flex flex-col justify-center">
              <div className="flex items-baseline space-x-0.5">
                {appConfig?.appName ? (
                  <span className="text-xl sm:text-2xl font-black tracking-tighter uppercase leading-none italic text-white">
                    {appConfig.appName}
                  </span>
                ) : (
                  <>
              ...
              <span className="text-[8px] sm:text-[9px] font-black tracking-[0.45em] text-white/50 uppercase mt-1">
