...
import { Package, Calendar, MapPin, CheckCircle, ChevronRight, Search, X, FileText, Trash2, ArrowUpRight, DollarSign, RotateCcw } from 'lucide-react';
                        ...
                        {profile?.role === 'client' && (
                          <button
                            onClick={(e) => {
                              e.preventDefault();
                              e.stopPropagation();
                              navigate('/client/new', { state: { duplicateDelivery: delivery } });
                            }}
                            className="px-3 h-10 bg-orange-500 hover:bg-orange-600 text-white rounded-xl flex items-center justify-center gap-1.5 transition-all font-black text-[10px] uppercase tracking-wider shrink-0 cursor-pointer shadow-sm active:scale-95"
