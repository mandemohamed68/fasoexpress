...
import BrandingThemeManager from './components/BrandingThemeManager';
...
function AppRoutes() {
      ...
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-8 text-center">
        ...
        >
          ...
          <p className="text-slate-400 font-bold text-sm max-w-sm leading-relaxed mb-8">
            {appConfig.maintenanceMessage || `Nous effectuons actuellement une mise à jour cruciale de ${appConfig?.appName || 'notre plateforme'} pour améliorer votre expérience. Nous serons de retour dans quelques instants.`}
          </p>
          <div className="px-6 py-2 bg-white/5 rounded-full text-[10px] font-black text-slate-500 uppercase tracking-widest border border-white/5 italic">
            Équipe Technique {appConfig?.appName || "FASO EXPRESS"}
          </div>
        </motion.div>
      </div>
    );
  ...
  return (
    <div className={cn(
      ...
      {/* Giant faint overlay watermark of Logo */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] opacity-[0.035] pointer-events-none z-0 select-none">
        <img src={appConfig?.logoUrl || appConfig?.appLogo || "/LOGOFASO.png"} alt="" className="w-full h-full object-contain filter select-none" />
      </div>
        ...
        <Suspense fallback={
          ...
          <AnimatePresence mode="wait" initial={false}>
            <Routes location={location} key={location.pathname}>
              ...
              <Route path="/accueil" element={<PageWrapper><ShowcaseView /></PageWrapper>} />
              <Route path="/presentation" element={<PageWrapper><ShowcaseView /></PageWrapper>} />
              <Route path="/about" element={<PageWrapper><ShowcaseView /></PageWrapper>} />
              <Route path="/showcase" element={<PageWrapper><ShowcaseView /></PageWrapper>} />
                ...
                <Route path="/Conditions_Générales" element={<PageWrapper><LegalView /></PageWrapper>} />
                <Route path="/Conditions_Generales" element={<PageWrapper><LegalView /></PageWrapper>} />
                <Route path="/Conditions_générales" element={<PageWrapper><LegalView /></PageWrapper>} />
                <Route path="/conditions-generales" element={<PageWrapper><LegalView /></PageWrapper>} />
                <Route path="/conditions_generales" element={<PageWrapper><LegalView /></PageWrapper>} />
                <Route path="/conditions" element={<PageWrapper><LegalView /></PageWrapper>} />
                <Route path="/terms" element={<PageWrapper><LegalView /></PageWrapper>} />
                <Route path="/cgu" element={<PageWrapper><LegalView /></PageWrapper>} />

                <Route path="/Politique de Confidentialité" element={<PageWrapper><LegalView /></PageWrapper>} />
                <Route path="/Politique%20de%20Confidentialit%C3%A9" element={<PageWrapper><LegalView /></PageWrapper>} />
                <Route path="/Politique_de_Confidentialité" element={<PageWrapper><LegalView /></PageWrapper>} />
                <Route path="/Politique_de_Confidentialite" element={<PageWrapper><LegalView /></PageWrapper>} />
