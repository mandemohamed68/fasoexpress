export interface PromoPopupConfig {
  ...
  targetAudience?: 'all' | 'clients' | 'drivers' | 'guests';
}
...
export interface AppConfig {
  ...
  // Dynamic Branding and Seasonal Themes
  appName?: string;
  appSlogan?: string;
  brandingTheme?: 'classic' | 'christmas' | 'newyear' | 'independenceday' | 'valentines' | 'rainy' | 'harmattan' | 'ramadan' | 'burkina' | 'spring' | 'custom' | 'standard';
  primaryColor?: string;
  ...
  // Interstitial Promotional Popup
...
export interface CommissionSettings {
  ...
  enableMinPriceConstraint?: boolean;
