...
-- ----------------------------
-- Table structure for deliveries (PARTITIONED)
-- ----------------------------
...
-- ----------------------------
-- Table structure for messages (PARTITIONED)
-- ----------------------------
...
-- ----------------------------
-- Table structure for notifications (PARTITIONED)
-- ----------------------------
...
-- ----------------------------
-- Table structure for withdrawals (PARTITIONED)
-- ----------------------------
CREATE TABLE IF NOT EXISTS `withdrawals` (
  ...
  `phone` varchar(50) DEFAULT NULL,
  `withdrawalInfo` text DEFAULT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- ----------------------------
-- Table structure for historique_gains (PARTITIONED)
-- ----------------------------
...
-- ----------------------------
-- Table structure for bids (PARTITIONED)
-- ----------------------------
